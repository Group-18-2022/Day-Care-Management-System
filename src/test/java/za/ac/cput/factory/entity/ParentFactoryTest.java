...
class ParentFactoryTest {
    ...
    @BeforeEach
    void setUp() {
        parent = new ParentFactory().buildParent("1", "John", "Smith", "12 Bell Street", "0123456540");
    }
    ...
    void testParentFactoryCreation() {
        assertAll(
                ...
                () -> assertEquals("0123456540", parent.getPhoneNumber())
        );
    }
    ...
    void testParentFactoryForNull() {
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            ParentFactory.buildParent(null, null, null, null, null);
        });
